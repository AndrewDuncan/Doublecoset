...
this to $(\G_A,s_0,f_0)$.  
If $\mathcal{S}=\{s_0\}=\mathcal{F}$ 
we 
call $s_0$ the {\em root}
vertex of $\G_A$ and say that $A$ and $\G_A$ are {\em rooted}. We may
 write $(\G_A,s_0)$ for $(\G_A,s_0,f_0)$ if this is the case. The
...
consider inversive automaton only. The automaton $A$ 
...
properties of automata (like rooted, trim, inversive or
folded) to graphs in general and $\G_A$ in particular.
...
\ref{sec:foldings}). For more details of foldings see \cite{ventura11}.
...
A morphism of  rooted, directed, labelled 
