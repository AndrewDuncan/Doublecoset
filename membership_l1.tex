...
\be[{C}1]
\item\label{it:C1} Construct $\D_k$ and the map $\nu$.  In more detail the steps are
the following.
\be
\item\label{it:C1a} Remove all edges of type $X_{k'}$, where $k'=1-k$, from $\D$; adding
...
\item\label{it:C1c} Rename vertices of $\D_k$: a vertex named $v$ in $\D$ becomes
$(v,k)$ in $\D_k$.
\item\label{it:C1d} For each vertex $(v,k)$ of $\D_k$ keep a record of the image
...
\item\label{it:C3} Construct the Stallings folding of (each component of)
...
\item\label{it:C5} Construct a spanning forest $\U_k$ of $\cP_k$ and, simultaneously,
...
\item\label{it:C6} For each vertex $\a$ of $\D_k$ do the following.
 Let
...
\item\label{it:C7} Construct the Stallings folding of $\D_k$ and update $\nu$.
This version of $\D_k$ is referred to as $\D_{k,2}$.
...
$\cP_{k,3}$ and $\U_{k,3}$.
\item\label{it:C9} For all vertices of $\cP_k$ of the form $(\a,1)$ do the following.
Let $\theta(\a)$ be the component of $\cP_k$ containing $(\a,1)$.
For each edge $e$ of $\theta(\a)\bs \U_k$: if $e=((\a_i,\b_1),x ,(\a_j,\b_2))$, 
where $\a_i,\a_j$ are vertices of $\D_k$ and $\b_1,\b_2$ are vertices
...
\item\label{it:C10} Construct the Stallings folding of $\D_k$ and update $\nu$. 
This version of $\D_k$ is referred to as $\D_{k,3}$.
\item\label{it:C11} (\textbf{Begin Modification 4}.)
 Update $\cP_k=\D_k\times \G_{A_k}$ and $\U_k$, by adding new isolated vertices
if necessary. We refer to these versions of $\cP_k$ and $\U_k$ as
$\cP_{k,4}$ and $\U_{k,4}$.
\item\label{it:C12} For all vertices of $\cP_k$ of the form $(\a,1)$ do the following.
Let $\theta(\a)$ be the component of $\cP_k$ containing $(\a,1)$.
...
\item\label{it:C13} Construct the Stallings folding of $\D_k$ and update $\nu$.
This version of $\D_k$ is referred to as $\D_{k,4}$.
...
$\cP_{k,5}$ and $\U_{k,5}$.
\item\label{it:C15} For all $\b\in V(\D_k)$ do the following. For $(\e,\xi)\in P$,
...
This version of $\D_k$ is referred to as $\D_{k,4}'$.
\item\label{it:C16} Construct the Stallings folding of $\D_k$ and update $\nu$. 
This version of $\D_k$ is referred to as $\D_{k,5}$.
\item\label{it:C17} (\textbf{Begin Reassembly}.) For each vertex $(u,k)$ of $\D_{1,5}\cup \D_{2,5}$,
do the following. For each vertex $(v,k')$ of $\D_{1,5}\cup \D_{2,5}$, not
equal to $(u,k)$, if
$\vim((u,k))\cap \vim((v,k'))\neq \emptyset$ then set $\vim((u,k))=\vim((u,k))\cup
\vim((v,k'))$. For each edge $e$ of $\D_{1,5}\cup \D_{2,5}$, if $e$ has
...
Continue for as long as possible. The resulting graph is denoted $\D'_5$.
\item\label{it:C18}  For each vertex $\a$ of $\D_Z$, if $\a\in \vim(u,k)$,
 for some
 vertex $(u,k)$ of $\D'_5$ then replace $\a$ with $(u,k)$. (Note that, as
...
\begin{figure}
\begin{center}
\psfrag{1-1}{\hspace{-4pt}\raisebox{-2pt}{\small $1,1$}} 
\psfrag{1-2}{\hspace{-4pt}\raisebox{-2pt}{\small $1,2$}} 
\psfrag{1-3}{\hspace{-4pt}\raisebox{-2pt}{\small $1,3$}} 
\psfrag{1-4}{\hspace{-4pt}\raisebox{-2pt}{\small $1,4$}} 
\psfrag{1-5}{\hspace{-4pt}\raisebox{-2pt}{\small $1,5$}} 
\psfrag{1-6}{\hspace{-4pt}\raisebox{-2pt}{\small $1,6$}} 
\psfrag{1-7}{\hspace{-4pt}\raisebox{-2pt}{\small $1,7$}} 
\psfrag{1-8}{\hspace{-4pt}\raisebox{-2pt}{\small $1,8$}} 
\psfrag{1-9}{\hspace{-4pt}\raisebox{-2pt}{\small $1,9$}}
\psfrag{2-1}{\hspace{-4pt}\raisebox{-2pt}{\small $2,1$}} 
\psfrag{2-2}{\hspace{-4pt}\raisebox{-2pt}{\small $2,2$}} 
\psfrag{2-3}{\hspace{-4pt}\raisebox{-2pt}{\small $2,3$}} 
\psfrag{2-4}{\hspace{-4pt}\raisebox{-2pt}{\small $2,4$}} 
\psfrag{2-5}{\hspace{-4pt}\raisebox{-2pt}{\small $2,5$}} 
\psfrag{2-6}{\hspace{-4pt}\raisebox{-2pt}{\small $2,6$}} 
\psfrag{2-7}{\hspace{-4pt}\raisebox{-2pt}{\small $2,7$}} 
\psfrag{2-8}{\hspace{-4pt}\raisebox{-2pt}{\small $2,8$}} 
\psfrag{2-9}{\hspace{-4pt}\raisebox{-2pt}{\small $2,9$}}
\psfrag{3-1}{\hspace{-4pt}\raisebox{-2pt}{\small $3,1$}} 
\psfrag{3-2}{\hspace{-4pt}\raisebox{-2pt}{\small $3,2$}} 
\psfrag{3-3}{\hspace{-4pt}\raisebox{-2pt}{\small $3,3$}} 
\psfrag{3-4}{\hspace{-4pt}\raisebox{-2pt}{\small $3,4$}} 
\psfrag{3-5}{\hspace{-4pt}\raisebox{-2pt}{\small $3,5$}} 
\psfrag{3-6}{\hspace{-4pt}\raisebox{-2pt}{\small $3,6$}} 
\psfrag{3-7}{\hspace{-4pt}\raisebox{-2pt}{\small $3,7$}} 
\psfrag{3-8}{\hspace{-4pt}\raisebox{-2pt}{\small $3,8$}} 
\psfrag{3-9}{\hspace{-4pt}\raisebox{-2pt}{\small $3,9$}}
\psfrag{4-1}{\hspace{-4pt}\raisebox{-2pt}{\small $4,1$}} 
\psfrag{4-2}{\hspace{-4pt}\raisebox{-2pt}{\small $4,2$}} 
\psfrag{4-3}{\hspace{-4pt}\raisebox{-2pt}{\small $4,3$}} 
\psfrag{4-4}{\hspace{-4pt}\raisebox{-2pt}{\small $4,4$}} 
\psfrag{4-5}{\hspace{-4pt}\raisebox{-2pt}{\small $4,5$}} 
\psfrag{4-6}{\hspace{-4pt}\raisebox{-2pt}{\small $4,6$}} 
\psfrag{4-7}{\hspace{-4pt}\raisebox{-2pt}{\small $4,7$}} 
\psfrag{4-8}{\hspace{-4pt}\raisebox{-2pt}{\small $4,8$}} 
\psfrag{4-9}{\hspace{-4pt}\raisebox{-2pt}{\small $4,9$}}
\psfrag{5-1}{\hspace{-4pt}\raisebox{-2pt}{\small $5,1$}} 
\psfrag{5-2}{\hspace{-4pt}\raisebox{-2pt}{\small $5,2$}} 
\psfrag{5-3}{\hspace{-4pt}\raisebox{-2pt}{\small $5,3$}} 
\psfrag{5-4}{\hspace{-4pt}\raisebox{-2pt}{\small $5,4$}} 
\psfrag{5-5}{\hspace{-4pt}\raisebox{-2pt}{\small $5,5$}} 
\psfrag{5-6}{\hspace{-4pt}\raisebox{-2pt}{\small $5,6$}} 
\psfrag{5-7}{\hspace{-4pt}\raisebox{-2pt}{\small $5,7$}} 
\psfrag{5-8}{\hspace{-4pt}\raisebox{-2pt}{\small $5,8$}} 
\psfrag{5-9}{\hspace{-4pt}\raisebox{-2pt}{\small $5,9$}}
\psfrag{6-1}{\hspace{-4pt}\raisebox{-2pt}{\small $6,1$}} 
\psfrag{6-2}{\hspace{-4pt}\raisebox{-2pt}{\small $6,2$}} 
\psfrag{6-3}{\hspace{-4pt}\raisebox{-2pt}{\small $6,3$}} 
\psfrag{6-4}{\hspace{-4pt}\raisebox{-2pt}{\small $6,4$}} 
\psfrag{6-5}{\hspace{-4pt}\raisebox{-2pt}{\small $6,5$}} 
\psfrag{6-6}{\hspace{-4pt}\raisebox{-2pt}{\small $6,6$}} 
\psfrag{6-7}{\hspace{-4pt}\raisebox{-2pt}{\small $6,7$}} 
\psfrag{6-8}{\hspace{-4pt}\raisebox{-2pt}{\small $6,8$}} 
\psfrag{6-9}{\hspace{-4pt}\raisebox{-2pt}{\small $6,9$}}
\psfrag{7-1}{\hspace{-4pt}\raisebox{-2pt}{\small $7,1$}} 
\psfrag{7-2}{\hspace{-4pt}\raisebox{-2pt}{\small $7,2$}} 
\psfrag{7-3}{\hspace{-4pt}\raisebox{-2pt}{\small $7,3$}} 
\psfrag{7-4}{\hspace{-4pt}\raisebox{-2pt}{\small $7,4$}} 
\psfrag{7-5}{\hspace{-4pt}\raisebox{-2pt}{\small $7,5$}} 
\psfrag{7-6}{\hspace{-4pt}\raisebox{-2pt}{\small $7,6$}} 
\psfrag{7-7}{\hspace{-4pt}\raisebox{-2pt}{\small $7,7$}} 
\psfrag{7-8}{\hspace{-4pt}\raisebox{-2pt}{\small $7,8$}} 
\psfrag{7-9}{\hspace{-4pt}\raisebox{-2pt}{\small $7,9$}}
\psfrag{8-1}{\hspace{-4pt}\raisebox{-2pt}{\small $8,1$}} 
\psfrag{8-2}{\hspace{-4pt}\raisebox{-2pt}{\small $8,2$}} 
\psfrag{8-3}{\hspace{-4pt}\raisebox{-2pt}{\small $8,3$}} 
\psfrag{8-4}{\hspace{-4pt}\raisebox{-2pt}{\small $8,4$}} 
\psfrag{8-5}{\hspace{-4pt}\raisebox{-2pt}{\small $8,5$}} 
\psfrag{8-6}{\hspace{-4pt}\raisebox{-2pt}{\small $8,6$}} 
\psfrag{8-7}{\hspace{-4pt}\raisebox{-2pt}{\small $8,7$}} 
\psfrag{8-8}{\hspace{-4pt}\raisebox{-2pt}{\small $8,8$}} 
\psfrag{8-9}{\hspace{-4pt}\raisebox{-2pt}{\small $8,9$}}
\psfrag{9-1}{\hspace{-4pt}\raisebox{-2pt}{\small $9,1$}} 
\psfrag{9-2}{\hspace{-4pt}\raisebox{-2pt}{\small $9,2$}} 
\psfrag{9-3}{\hspace{-4pt}\raisebox{-2pt}{\small $9,3$}} 
\psfrag{9-4}{\hspace{-4pt}\raisebox{-2pt}{\small $9,4$}} 
\psfrag{9-5}{\hspace{-4pt}\raisebox{-2pt}{\small $9,5$}} 
\psfrag{9-6}{\hspace{-4pt}\raisebox{-2pt}{\small $9,6$}} 
\psfrag{9-7}{\hspace{-4pt}\raisebox{-2pt}{\small $9,7$}} 
\psfrag{9-8}{\hspace{-4pt}\raisebox{-2pt}{\small $9,8$}} 
\psfrag{9-9}{\hspace{-4pt}\raisebox{-2pt}{\small $9,9$}}
\psfrag{10-1}{\hspace{-4pt}\raisebox{-2pt}{\small $10,1$}} 
\psfrag{10-2}{\hspace{-4pt}\raisebox{-2pt}{\small $10,2$}} 
\psfrag{10-3}{\hspace{-4pt}\raisebox{-2pt}{\small $10,3$}} 
\psfrag{10-4}{\hspace{-4pt}\raisebox{-2pt}{\small $10,4$}} 
\psfrag{10-5}{\hspace{-4pt}\raisebox{-2pt}{\small $10,5$}} 
\psfrag{10-6}{\hspace{-4pt}\raisebox{-2pt}{\small $10,6$}} 
\psfrag{10-7}{\hspace{-4pt}\raisebox{-2pt}{\small $10,7$}}  
\psfrag{10-8}{\hspace{-4pt}\raisebox{-2pt}{\small $10,8$}} 
\psfrag{10-9}{\hspace{-4pt}\raisebox{-2pt}{\small $10,9$}}
\psfrag{11-1}{\hspace{-4pt}\raisebox{-2pt}{\small $11,1$}} 
\psfrag{11-2}{\hspace{-4pt}\raisebox{-2pt}{\small $11,2$}} 
\psfrag{11-3}{\hspace{-4pt}\raisebox{-2pt}{\small $11,3$}} 
\psfrag{11-4}{\hspace{-4pt}\raisebox{-2pt}{\small $11,4$}} 
\psfrag{11-5}{\hspace{-4pt}\raisebox{-2pt}{\small $11,5$}} 
\psfrag{11-6}{\hspace{-4pt}\raisebox{-2pt}{\small $11,6$}} 
\psfrag{11-7}{\hspace{-4pt}\raisebox{-2pt}{\small $11,7$}}  
\psfrag{11-8}{\hspace{-4pt}\raisebox{-2pt}{\small $11,8$}} 
\psfrag{11-9}{\hspace{-4pt}\raisebox{-2pt}{\small $11,9$}}
\psfrag{12-1}{\hspace{-4pt}\raisebox{-2pt}{\small $12,1$}} 
\psfrag{12-2}{\hspace{-4pt}\raisebox{-2pt}{\small $12,2$}} 
\psfrag{12-3}{\hspace{-4pt}\raisebox{-2pt}{\small $12,3$}} 
\psfrag{12-4}{\hspace{-4pt}\raisebox{-2pt}{\small $12,4$}} 
\psfrag{12-5}{\hspace{-4pt}\raisebox{-2pt}{\small $12,5$}} 
\psfrag{12-6}{\hspace{-4pt}\raisebox{-2pt}{\small $12,6$}} 
\psfrag{12-7}{\hspace{-4pt}\raisebox{-2pt}{\small $12,7$}}  
\psfrag{12-8}{\hspace{-4pt}\raisebox{-2pt}{\small $12,8$}} 
\psfrag{12-9}{\hspace{-4pt}\raisebox{-2pt}{\small $12,9$}}
\psfrag{13-1}{\hspace{-4pt}\raisebox{-2pt}{\small $13,1$}} 
\psfrag{13-2}{\hspace{-4pt}\raisebox{-2pt}{\small $13,2$}} 
\psfrag{13-3}{\hspace{-4pt}\raisebox{-2pt}{\small $13,3$}} 
\psfrag{13-4}{\hspace{-4pt}\raisebox{-2pt}{\small $13,4$}} 
\psfrag{13-5}{\hspace{-4pt}\raisebox{-2pt}{\small $13,5$}} 
\psfrag{13-6}{\hspace{-4pt}\raisebox{-2pt}{\small $13,6$}} 
\psfrag{13-7}{\hspace{-4pt}\raisebox{-2pt}{\small $13,7$}}  
\psfrag{13-8}{\hspace{-4pt}\raisebox{-2pt}{\small $13,8$}} 
\psfrag{13-9}{\hspace{-4pt}\raisebox{-2pt}{\small $13,9$}}
\psfrag{14-1}{\hspace{-4pt}\raisebox{-2pt}{\small $14,1$}} 
\psfrag{14-2}{\hspace{-4pt}\raisebox{-2pt}{\small $14,2$}} 
\psfrag{14-3}{\hspace{-4pt}\raisebox{-2pt}{\small $14,3$}} 
\psfrag{14-4}{\hspace{-4pt}\raisebox{-2pt}{\small $14,4$}} 
\psfrag{14-5}{\hspace{-4pt}\raisebox{-2pt}{\small $14,5$}} 
\psfrag{14-6}{\hspace{-4pt}\raisebox{-2pt}{\small $14,6$}} 
\psfrag{14-7}{\hspace{-4pt}\raisebox{-2pt}{\small $14,7$}}  
\psfrag{14-8}{\hspace{-4pt}\raisebox{-2pt}{\small $14,8$}} 
\psfrag{14-9}{\hspace{-4pt}\raisebox{-2pt}{\small $14,9$}}
\psfrag{15-1}{\hspace{-4pt}\raisebox{-2pt}{\small $15,1$}} 
\psfrag{15-2}{\hspace{-4pt}\raisebox{-2pt}{\small $15,2$}} 
\psfrag{15-3}{\hspace{-4pt}\raisebox{-2pt}{\small $15,3$}} 
\psfrag{15-4}{\hspace{-4pt}\raisebox{-2pt}{\small $15,4$}} 
\psfrag{15-5}{\hspace{-4pt}\raisebox{-2pt}{\small $15,5$}} 
\psfrag{15-6}{\hspace{-4pt}\raisebox{-2pt}{\small $15,6$}} 
\psfrag{15-7}{\hspace{-4pt}\raisebox{-2pt}{\small $15,7$}}  
\psfrag{15-8}{\hspace{-4pt}\raisebox{-2pt}{\small $15,8$}} 
\psfrag{15-9}{\hspace{-4pt}\raisebox{-2pt}{\small $15,9$}}
\psfrag{16-1}{\hspace{-4pt}\raisebox{-2pt}{\small $16,1$}} 
\psfrag{16-2}{\hspace{-4pt}\raisebox{-2pt}{\small $16,2$}} 
\psfrag{16-3}{\hspace{-4pt}\raisebox{-2pt}{\small $16,3$}} 
\psfrag{16-4}{\hspace{-4pt}\raisebox{-2pt}{\small $16,4$}} 
\psfrag{16-5}{\hspace{-4pt}\raisebox{-2pt}{\small $16,5$}} 
\psfrag{16-6}{\hspace{-4pt}\raisebox{-2pt}{\small $16,6$}} 
\psfrag{16-7}{\hspace{-4pt}\raisebox{-2pt}{\small $16,7$}}  
\psfrag{16-8}{\hspace{-4pt}\raisebox{-2pt}{\small $16,8$}} 
\psfrag{16-9}{\hspace{-4pt}\raisebox{-2pt}{\small $16,9$}}
\psfrag{17-1}{\hspace{-4pt}\raisebox{-2pt}{\small $17,1$}} 
\psfrag{17-2}{\hspace{-4pt}\raisebox{-2pt}{\small $17,2$}} 
\psfrag{17-3}{\hspace{-4pt}\raisebox{-2pt}{\small $17,3$}} 
\psfrag{17-4}{\hspace{-4pt}\raisebox{-2pt}{\small $17,4$}} 
\psfrag{17-5}{\hspace{-4pt}\raisebox{-2pt}{\small $17,5$}} 
\psfrag{17-6}{\hspace{-4pt}\raisebox{-2pt}{\small $17,6$}} 
\psfrag{17-7}{\hspace{-4pt}\raisebox{-2pt}{\small $17,7$}}  
\psfrag{17-8}{\hspace{-4pt}\raisebox{-2pt}{\small $17,8$}} 
\psfrag{17-9}{\hspace{-4pt}\raisebox{-2pt}{\small $17,9$}}
\psfrag{18-1}{\hspace{-4pt}\raisebox{-2pt}{\small $18,1$}} 
\psfrag{18-2}{\hspace{-4pt}\raisebox{-2pt}{\small $18,2$}} 
\psfrag{18-3}{\hspace{-4pt}\raisebox{-2pt}{\small $18,3$}} 
\psfrag{18-4}{\hspace{-4pt}\raisebox{-2pt}{\small $18,4$}} 
\psfrag{18-5}{\hspace{-4pt}\raisebox{-2pt}{\small $18,5$}} 
\psfrag{18-6}{\hspace{-4pt}\raisebox{-2pt}{\small $18,6$}} 
\psfrag{18-7}{\hspace{-4pt}\raisebox{-2pt}{\small $18,7$}}  
\psfrag{18-8}{\hspace{-4pt}\raisebox{-2pt}{\small $18,8$}} 
\psfrag{18-9}{\hspace{-4pt}\raisebox{-2pt}{\small $18,9$}}
\psfrag{19-1}{\hspace{-4pt}\raisebox{-2pt}{\small $19,1$}} 
\psfrag{19-2}{\hspace{-4pt}\raisebox{-2pt}{\small $19,2$}} 
\psfrag{19-3}{\hspace{-4pt}\raisebox{-2pt}{\small $19,3$}} 
\psfrag{19-4}{\hspace{-4pt}\raisebox{-2pt}{\small $19,4$}} 
\psfrag{19-5}{\hspace{-4pt}\raisebox{-2pt}{\small $19,5$}} 
\psfrag{19-6}{\hspace{-4pt}\raisebox{-2pt}{\small $19,6$}} 
\psfrag{19-7}{\hspace{-4pt}\raisebox{-2pt}{\small $19,7$}}  
\psfrag{19-8}{\hspace{-4pt}\raisebox{-2pt}{\small $19,8$}} 
\psfrag{19-9}{\hspace{-4pt}\raisebox{-2pt}{\small $19,9$}}
\psfrag{20-1}{\hspace{-4pt}\raisebox{-2pt}{\small $20,1$}} 
\psfrag{20-2}{\hspace{-4pt}\raisebox{-2pt}{\small $20,2$}} 
\psfrag{20-3}{\hspace{-4pt}\raisebox{-2pt}{\small $20,3$}} 
\psfrag{20-4}{\hspace{-4pt}\raisebox{-2pt}{\small $20,4$}} 
\psfrag{20-5}{\hspace{-4pt}\raisebox{-2pt}{\small $20,5$}} 
\psfrag{20-6}{\hspace{-4pt}\raisebox{-2pt}{\small $20,6$}} 
\psfrag{20-7}{\hspace{-4pt}\raisebox{-2pt}{\small $20,7$}}  
\psfrag{20-8}{\hspace{-4pt}\raisebox{-2pt}{\small $20,8$}} 
\psfrag{20-9}{\hspace{-4pt}\raisebox{-2pt}{\small $20,9$}}
\psfrag{21-1}{\hspace{-4pt}\raisebox{-2pt}{\small $21,1$}} 
\psfrag{21-2}{\hspace{-4pt}\raisebox{-2pt}{\small $21,2$}} 
\psfrag{21-3}{\hspace{-4pt}\raisebox{-2pt}{\small $21,3$}} 
\psfrag{21-4}{\hspace{-4pt}\raisebox{-2pt}{\small $21,4$}} 
\psfrag{21-5}{\hspace{-4pt}\raisebox{-2pt}{\small $21,5$}} 
\psfrag{21-6}{\hspace{-4pt}\raisebox{-2pt}{\small $21,6$}} 
\psfrag{21-7}{\hspace{-4pt}\raisebox{-2pt}{\small $21,7$}}  
\psfrag{21-8}{\hspace{-4pt}\raisebox{-2pt}{\small $21,8$}} 
\psfrag{21-9}{\hspace{-4pt}\raisebox{-2pt}{\small $21,9$}}
\psfrag{22-1}{\hspace{-4pt}\raisebox{-2pt}{\small $22,1$}} 
\psfrag{22-2}{\hspace{-4pt}\raisebox{-2pt}{\small $22,2$}} 
\psfrag{22-3}{\hspace{-4pt}\raisebox{-2pt}{\small $22,3$}} 
\psfrag{22-4}{\hspace{-4pt}\raisebox{-2pt}{\small $22,4$}} 
\psfrag{22-5}{\hspace{-4pt}\raisebox{-2pt}{\small $22,5$}} 
\psfrag{22-6}{\hspace{-4pt}\raisebox{-2pt}{\small $22,6$}} 
\psfrag{22-7}{\hspace{-4pt}\raisebox{-2pt}{\small $22,7$}}  
\psfrag{22-8}{\hspace{-4pt}\raisebox{-2pt}{\small $22,8$}} 
\psfrag{22-9}{\hspace{-4pt}\raisebox{-2pt}{\small $22,9$}}
\psfrag{23-1}{\hspace{-4pt}\raisebox{-2pt}{\small $23,1$}} 
\psfrag{23-2}{\hspace{-4pt}\raisebox{-2pt}{\small $23,2$}} 
\psfrag{23-3}{\hspace{-4pt}\raisebox{-2pt}{\small $23,3$}} 
\psfrag{23-4}{\hspace{-4pt}\raisebox{-2pt}{\small $23,4$}} 
\psfrag{23-5}{\hspace{-4pt}\raisebox{-2pt}{\small $23,5$}} 
\psfrag{23-6}{\hspace{-4pt}\raisebox{-2pt}{\small $23,6$}} 
\psfrag{23-7}{\hspace{-4pt}\raisebox{-2pt}{\small $23,7$}}  
\psfrag{23-8}{\hspace{-4pt}\raisebox{-2pt}{\small $23,8$}} 
\psfrag{23-9}{\hspace{-4pt}\raisebox{-2pt}{\small $23,9$}}
\psfrag{24-1}{\hspace{-4pt}\raisebox{-2pt}{\small $24,1$}} 
\psfrag{24-2}{\hspace{-4pt}\raisebox{-2pt}{\small $24,2$}} 
\psfrag{24-3}{\hspace{-4pt}\raisebox{-2pt}{\small $24,3$}} 
\psfrag{24-4}{\hspace{-4pt}\raisebox{-2pt}{\small $24,4$}} 
\psfrag{24-5}{\hspace{-4pt}\raisebox{-2pt}{\small $24,5$}} 
\psfrag{24-6}{\hspace{-4pt}\raisebox{-2pt}{\small $24,6$}} 
\psfrag{24-7}{\hspace{-4pt}\raisebox{-2pt}{\small $24,7$}}  
\psfrag{24-8}{\hspace{-4pt}\raisebox{-2pt}{\small $24,8$}} 
\psfrag{24-9}{\hspace{-4pt}\raisebox{-2pt}{\small $24,9$}}
\psfrag{25-1}{\hspace{-4pt}\raisebox{-2pt}{\small $25,1$}} 
\psfrag{25-2}{\hspace{-4pt}\raisebox{-2pt}{\small $25,2$}} 
\psfrag{25-3}{\hspace{-4pt}\raisebox{-2pt}{\small $25,3$}} 
\psfrag{25-4}{\hspace{-4pt}\raisebox{-2pt}{\small $25,4$}} 
\psfrag{25-5}{\hspace{-4pt}\raisebox{-2pt}{\small $25,5$}} 
\psfrag{25-6}{\hspace{-4pt}\raisebox{-2pt}{\small $25,6$}} 
\psfrag{25-7}{\hspace{-4pt}\raisebox{-2pt}{\small $25,7$}}  
\psfrag{25-8}{\hspace{-4pt}\raisebox{-2pt}{\small $25,8$}} 
\psfrag{25-9}{\hspace{-4pt}\raisebox{-2pt}{\small $25,9$}}
\psfrag{26-1}{\hspace{-4pt}\raisebox{-2pt}{\small $26,1$}} 
\psfrag{26-2}{\hspace{-4pt}\raisebox{-2pt}{\small $26,2$}} 
\psfrag{26-3}{\hspace{-4pt}\raisebox{-2pt}{\small $26,3$}} 
\psfrag{26-4}{\hspace{-4pt}\raisebox{-2pt}{\small $26,4$}} 
\psfrag{26-5}{\hspace{-4pt}\raisebox{-2pt}{\small $26,5$}} 
\psfrag{26-6}{\hspace{-4pt}\raisebox{-2pt}{\small $26,6$}} 
\psfrag{26-7}{\hspace{-4pt}\raisebox{-2pt}{\small $26,7$}}  
\psfrag{26-8}{\hspace{-4pt}\raisebox{-2pt}{\small $26,8$}} 
\psfrag{26-9}{\hspace{-4pt}\raisebox{-2pt}{\small $26,9$}}
\psfrag{27-1}{\hspace{-4pt}\raisebox{-2pt}{\small $27,1$}} 
\psfrag{27-2}{\hspace{-4pt}\raisebox{-2pt}{\small $27,2$}} 
\psfrag{27-3}{\hspace{-4pt}\raisebox{-2pt}{\small $27,3$}} 
\psfrag{27-4}{\hspace{-4pt}\raisebox{-2pt}{\small $27,4$}} 
\psfrag{27-5}{\hspace{-4pt}\raisebox{-2pt}{\small $27,5$}} 
\psfrag{27-6}{\hspace{-4pt}\raisebox{-2pt}{\small $27,6$}} 
\psfrag{27-7}{\hspace{-4pt}\raisebox{-2pt}{\small $27,7$}}  
\psfrag{27-8}{\hspace{-4pt}\raisebox{-2pt}{\small $27,8$}} 
\psfrag{27-9}{\hspace{-4pt}\raisebox{-2pt}{\small $27,9$}}
\psfrag{28-1}{\hspace{-4pt}\raisebox{-2pt}{\small $28,1$}} 
\psfrag{28-2}{\hspace{-4pt}\raisebox{-2pt}{\small $28,2$}} 
\psfrag{28-3}{\hspace{-4pt}\raisebox{-2pt}{\small $28,3$}} 
\psfrag{28-4}{\hspace{-4pt}\raisebox{-2pt}{\small $28,4$}} 
\psfrag{28-5}{\hspace{-4pt}\raisebox{-2pt}{\small $28,5$}} 
\psfrag{28-6}{\hspace{-4pt}\raisebox{-2pt}{\small $28,6$}} 
\psfrag{28-7}{\hspace{-4pt}\raisebox{-2pt}{\small $28,7$}}  
\psfrag{28-8}{\hspace{-4pt}\raisebox{-2pt}{\small $28,8$}} 
\psfrag{28-9}{\hspace{-4pt}\raisebox{-2pt}{\small $28,9$}}
\psfrag{29-1}{\hspace{-4pt}\raisebox{-2pt}{\small $29,1$}} 
\psfrag{29-2}{\hspace{-4pt}\raisebox{-2pt}{\small $29,2$}} 
\psfrag{29-3}{\hspace{-4pt}\raisebox{-2pt}{\small $29,3$}} 
\psfrag{29-4}{\hspace{-4pt}\raisebox{-2pt}{\small $29,4$}} 
\psfrag{29-5}{\hspace{-4pt}\raisebox{-2pt}{\small $29,5$}} 
\psfrag{29-6}{\hspace{-4pt}\raisebox{-2pt}{\small $29,6$}} 
\psfrag{29-7}{\hspace{-4pt}\raisebox{-2pt}{\small $29,7$}}  
\psfrag{29-8}{\hspace{-4pt}\raisebox{-2pt}{\small $29,8$}} 
\psfrag{29-9}{\hspace{-4pt}\raisebox{-2pt}{\small $29,9$}}
\psfrag{30-1}{\hspace{-4pt}\raisebox{-2pt}{\small $30,1$}} 
\psfrag{30-2}{\hspace{-4pt}\raisebox{-2pt}{\small $30,2$}} 
\psfrag{30-3}{\hspace{-4pt}\raisebox{-2pt}{\small $30,3$}} 
\psfrag{30-4}{\hspace{-4pt}\raisebox{-2pt}{\small $30,4$}} 
\psfrag{30-5}{\hspace{-4pt}\raisebox{-2pt}{\small $30,5$}} 
\psfrag{30-6}{\hspace{-4pt}\raisebox{-2pt}{\small $30,6$}} 
\psfrag{30-7}{\hspace{-4pt}\raisebox{-2pt}{\small $30,7$}}  
\psfrag{30-8}{\hspace{-4pt}\raisebox{-2pt}{\small $30,8$}} 
\psfrag{30-9}{\hspace{-4pt}\raisebox{-2pt}{\small $30,9$}}
\psfrag{31-1}{\hspace{-4pt}\raisebox{-2pt}{\small $31,1$}} 
\psfrag{31-2}{\hspace{-4pt}\raisebox{-2pt}{\small $31,2$}} 
\psfrag{31-3}{\hspace{-4pt}\raisebox{-2pt}{\small $31,3$}} 
\psfrag{31-4}{\hspace{-4pt}\raisebox{-2pt}{\small $31,4$}} 
\psfrag{31-5}{\hspace{-4pt}\raisebox{-2pt}{\small $31,5$}} 
\psfrag{31-6}{\hspace{-4pt}\raisebox{-2pt}{\small $31,6$}} 
\psfrag{31-7}{\hspace{-4pt}\raisebox{-2pt}{\small $31,7$}}  
\psfrag{31-8}{\hspace{-4pt}\raisebox{-2pt}{\small $31,8$}} 
\psfrag{31-9}{\hspace{-4pt}\raisebox{-2pt}{\small $31,9$}}
\psfrag{32-1}{\hspace{-4pt}\raisebox{-2pt}{\small $32,1$}} 
\psfrag{32-2}{\hspace{-4pt}\raisebox{-2pt}{\small $32,2$}} 
\psfrag{32-3}{\hspace{-4pt}\raisebox{-2pt}{\small $32,3$}} 
\psfrag{32-4}{\hspace{-4pt}\raisebox{-2pt}{\small $32,4$}} 
\psfrag{32-5}{\hspace{-4pt}\raisebox{-2pt}{\small $32,5$}} 
\psfrag{32-6}{\hspace{-4pt}\raisebox{-2pt}{\small $32,6$}} 
\psfrag{32-7}{\hspace{-4pt}\raisebox{-2pt}{\small $32,7$}}  
\psfrag{32-8}{\hspace{-4pt}\raisebox{-2pt}{\small $32,8$}} 
\psfrag{32-9}{\hspace{-4pt}\raisebox{-2pt}{\small $32,9$}}
\psfrag{33-1}{\hspace{-4pt}\raisebox{-2pt}{\small $33,1$}} 
\psfrag{33-2}{\hspace{-4pt}\raisebox{-2pt}{\small $33,2$}} 
\psfrag{33-3}{\hspace{-4pt}\raisebox{-2pt}{\small $33,3$}} 
\psfrag{33-4}{\hspace{-4pt}\raisebox{-2pt}{\small $33,4$}} 
\psfrag{33-5}{\hspace{-4pt}\raisebox{-2pt}{\small $33,5$}} 
\psfrag{33-6}{\hspace{-4pt}\raisebox{-2pt}{\small $33,6$}} 
\psfrag{33-7}{\hspace{-4pt}\raisebox{-2pt}{\small $33,7$}}  
\psfrag{33-8}{\hspace{-4pt}\raisebox{-2pt}{\small $33,8$}} 
\psfrag{33-9}{\hspace{-4pt}\raisebox{-2pt}{\small $33,9$}}
\psfrag{34-1}{\hspace{-4pt}\raisebox{-2pt}{\small $34,1$}} 
\psfrag{34-2}{\hspace{-4pt}\raisebox{-2pt}{\small $34,2$}} 
\psfrag{34-3}{\hspace{-4pt}\raisebox{-2pt}{\small $34,3$}} 
\psfrag{34-4}{\hspace{-4pt}\raisebox{-2pt}{\small $34,4$}} 
\psfrag{34-5}{\hspace{-4pt}\raisebox{-2pt}{\small $34,5$}} 
\psfrag{34-6}{\hspace{-4pt}\raisebox{-2pt}{\small $34,6$}} 
\psfrag{34-7}{\hspace{-4pt}\raisebox{-2pt}{\small $34,7$}}  
\psfrag{34-8}{\hspace{-4pt}\raisebox{-2pt}{\small $34,8$}} 
\psfrag{34-9}{\hspace{-4pt}\raisebox{-2pt}{\small $34,9$}}
\psfrag{35-1}{\hspace{-4pt}\raisebox{-2pt}{\small $35,1$}} 
\psfrag{35-2}{\hspace{-4pt}\raisebox{-2pt}{\small $35,2$}} 
\psfrag{35-3}{\hspace{-4pt}\raisebox{-2pt}{\small $35,3$}} 
\psfrag{35-4}{\hspace{-4pt}\raisebox{-2pt}{\small $35,4$}} 
\psfrag{35-5}{\hspace{-4pt}\raisebox{-2pt}{\small $35,5$}} 
\psfrag{35-6}{\hspace{-4pt}\raisebox{-2pt}{\small $35,6$}} 
\psfrag{35-7}{\hspace{-4pt}\raisebox{-2pt}{\small $35,7$}}  
\psfrag{35-8}{\hspace{-4pt}\raisebox{-2pt}{\small $35,8$}} 
\psfrag{35-9}{\hspace{-4pt}\raisebox{-2pt}{\small $35,9$}}
\psfrag{36-1}{\hspace{-4pt}\raisebox{-2pt}{\small $36,1$}} 
\psfrag{36-2}{\hspace{-4pt}\raisebox{-2pt}{\small $36,2$}} 
\psfrag{36-3}{\hspace{-4pt}\raisebox{-2pt}{\small $36,3$}} 
\psfrag{36-4}{\hspace{-4pt}\raisebox{-2pt}{\small $36,4$}} 
\psfrag{36-5}{\hspace{-4pt}\raisebox{-2pt}{\small $36,5$}} 
\psfrag{36-6}{\hspace{-4pt}\raisebox{-2pt}{\small $36,6$}} 
\psfrag{36-7}{\hspace{-4pt}\raisebox{-2pt}{\small $36,7$}}  
\psfrag{36-8}{\hspace{-4pt}\raisebox{-2pt}{\small $36,8$}} 
\psfrag{36-9}{\hspace{-4pt}\raisebox{-2pt}{\small $36,9$}}
\psfrag{37-1}{\hspace{-4pt}\raisebox{-2pt}{\small $37,1$}} 
\psfrag{37-2}{\hspace{-4pt}\raisebox{-2pt}{\small $37,2$}} 
\psfrag{37-3}{\hspace{-4pt}\raisebox{-2pt}{\small $37,3$}} 
\psfrag{37-4}{\hspace{-4pt}\raisebox{-2pt}{\small $37,4$}} 
\psfrag{37-5}{\hspace{-4pt}\raisebox{-2pt}{\small $37,5$}} 
\psfrag{37-6}{\hspace{-4pt}\raisebox{-2pt}{\small $37,6$}} 
\psfrag{37-7}{\hspace{-4pt}\raisebox{-2pt}{\small $37,7$}}  
\psfrag{37-8}{\hspace{-4pt}\raisebox{-2pt}{\small $37,8$}} 
\psfrag{37-9}{\hspace{-4pt}\raisebox{-2pt}{\small $37,9$}}
\psfrag{38-1}{\hspace{-4pt}\raisebox{-2pt}{\small $38,1$}} 
\psfrag{38-2}{\hspace{-4pt}\raisebox{-2pt}{\small $38,2$}} 
\psfrag{38-3}{\hspace{-4pt}\raisebox{-2pt}{\small $38,3$}} 
\psfrag{38-4}{\hspace{-4pt}\raisebox{-2pt}{\small $38,4$}} 
\psfrag{38-5}{\hspace{-4pt}\raisebox{-2pt}{\small $38,5$}} 
\psfrag{38-6}{\hspace{-4pt}\raisebox{-2pt}{\small $38,6$}} 
\psfrag{38-7}{\hspace{-4pt}\raisebox{-2pt}{\small $38,7$}}  
\psfrag{38-8}{\hspace{-4pt}\raisebox{-2pt}{\small $38,8$}} 
\psfrag{38-9}{\hspace{-4pt}\raisebox{-2pt}{\small $38,9$}}
\psfrag{39-1}{\hspace{-4pt}\raisebox{-2pt}{\small $39,1$}} 
\psfrag{39-2}{\hspace{-4pt}\raisebox{-2pt}{\small $39,2$}} 
\psfrag{39-3}{\hspace{-4pt}\raisebox{-2pt}{\small $39,3$}} 
\psfrag{39-4}{\hspace{-4pt}\raisebox{-2pt}{\small $39,4$}} 
\psfrag{39-5}{\hspace{-4pt}\raisebox{-2pt}{\small $39,5$}} 
\psfrag{39-6}{\hspace{-4pt}\raisebox{-2pt}{\small $39,6$}} 
\psfrag{39-7}{\hspace{-4pt}\raisebox{-2pt}{\small $39,7$}}  
\psfrag{39-8}{\hspace{-4pt}\raisebox{-2pt}{\small $39,8$}} 
\psfrag{39-9}{\hspace{-4pt}\raisebox{-2pt}{\small $39,9$}}
\psfrag{40-1}{\hspace{-4pt}\raisebox{-2pt}{\small $40,1$}} 
\psfrag{40-2}{\hspace{-4pt}\raisebox{-2pt}{\small $40,2$}} 
\psfrag{40-3}{\hspace{-4pt}\raisebox{-2pt}{\small $40,3$}} 
\psfrag{40-4}{\hspace{-4pt}\raisebox{-2pt}{\small $40,4$}} 
\psfrag{40-5}{\hspace{-4pt}\raisebox{-2pt}{\small $40,5$}} 
\psfrag{40-6}{\hspace{-4pt}\raisebox{-2pt}{\small $40,6$}} 
\psfrag{40-7}{\hspace{-4pt}\raisebox{-2pt}{\small $40,7$}}  
\psfrag{40-8}{\hspace{-4pt}\raisebox{-2pt}{\small $40,8$}} 
\psfrag{40-9}{\hspace{-4pt}\raisebox{-2pt}{\small $40,9$}}
\psfrag{41-1}{\hspace{-4pt}\raisebox{-2pt}{\small $41,1$}} 
\psfrag{41-2}{\hspace{-4pt}\raisebox{-2pt}{\small $41,2$}} 
\psfrag{41-3}{\hspace{-4pt}\raisebox{-2pt}{\small $41,3$}} 
\psfrag{41-4}{\hspace{-4pt}\raisebox{-2pt}{\small $41,4$}} 
\psfrag{41-5}{\hspace{-4pt}\raisebox{-2pt}{\small $41,5$}} 
\psfrag{41-6}{\hspace{-4pt}\raisebox{-2pt}{\small $41,6$}} 
\psfrag{41-7}{\hspace{-4pt}\raisebox{-2pt}{\small $41,7$}}  
\psfrag{41-8}{\hspace{-4pt}\raisebox{-2pt}{\small $41,8$}} 
\psfrag{41-9}{\hspace{-4pt}\raisebox{-2pt}{\small $41,9$}}
\psfrag{42-1}{\hspace{-4pt}\raisebox{-2pt}{\small $42,1$}} 
\psfrag{42-2}{\hspace{-4pt}\raisebox{-2pt}{\small $42,2$}} 
\psfrag{42-3}{\hspace{-4pt}\raisebox{-2pt}{\small $42,3$}} 
\psfrag{42-4}{\hspace{-4pt}\raisebox{-2pt}{\small $42,4$}} 
\psfrag{42-5}{\hspace{-4pt}\raisebox{-2pt}{\small $42,5$}} 
\psfrag{42-6}{\hspace{-4pt}\raisebox{-2pt}{\small $42,6$}} 
\psfrag{42-7}{\hspace{-4pt}\raisebox{-2pt}{\small $42,7$}}  
\psfrag{42-8}{\hspace{-4pt}\raisebox{-2pt}{\small $42,8$}} 
\psfrag{42-9}{\hspace{-4pt}\raisebox{-2pt}{\small $42,9$}}
\psfrag{43-1}{\hspace{-4pt}\raisebox{-2pt}{\small $43,1$}} 
\psfrag{43-2}{\hspace{-4pt}\raisebox{-2pt}{\small $43,2$}} 
\psfrag{43-3}{\hspace{-4pt}\raisebox{-2pt}{\small $43,3$}} 
\psfrag{43-4}{\hspace{-4pt}\raisebox{-2pt}{\small $43,4$}} 
\psfrag{43-5}{\hspace{-4pt}\raisebox{-2pt}{\small $43,5$}} 
\psfrag{43-6}{\hspace{-4pt}\raisebox{-2pt}{\small $43,6$}} 
\psfrag{43-7}{\hspace{-4pt}\raisebox{-2pt}{\small $43,7$}}  
\psfrag{43-8}{\hspace{-4pt}\raisebox{-2pt}{\small $43,8$}} 
\psfrag{43-9}{\hspace{-4pt}\raisebox{-2pt}{\small $43,9$}}
\psfrag{44-1}{\hspace{-4pt}\raisebox{-2pt}{\small $44,1$}} 
\psfrag{44-2}{\hspace{-4pt}\raisebox{-2pt}{\small $44,2$}} 
\psfrag{44-3}{\hspace{-4pt}\raisebox{-2pt}{\small $44,3$}} 
\psfrag{44-4}{\hspace{-4pt}\raisebox{-2pt}{\small $44,4$}} 
\psfrag{44-5}{\hspace{-4pt}\raisebox{-2pt}{\small $44,5$}} 
\psfrag{44-6}{\hspace{-4pt}\raisebox{-2pt}{\small $44,6$}} 
\psfrag{44-7}{\hspace{-4pt}\raisebox{-2pt}{\small $44,7$}}  
\psfrag{44-8}{\hspace{-4pt}\raisebox{-2pt}{\small $44,8$}} 
\psfrag{44-9}{\hspace{-4pt}\raisebox{-2pt}{\small $44,9$}}
\psfrag{45-1}{\hspace{-4pt}\raisebox{-2pt}{\small $45,1$}} 
\psfrag{45-2}{\hspace{-4pt}\raisebox{-2pt}{\small $45,2$}} 
\psfrag{45-3}{\hspace{-4pt}\raisebox{-2pt}{\small $45,3$}} 
\psfrag{45-4}{\hspace{-4pt}\raisebox{-2pt}{\small $45,4$}} 
\psfrag{45-5}{\hspace{-4pt}\raisebox{-2pt}{\small $45,5$}} 
\psfrag{45-6}{\hspace{-4pt}\raisebox{-2pt}{\small $45,6$}} 
\psfrag{45-7}{\hspace{-4pt}\raisebox{-2pt}{\small $45,7$}}  
\psfrag{45-8}{\hspace{-4pt}\raisebox{-2pt}{\small $45,8$}} 
\psfrag{45-9}{\hspace{-4pt}\raisebox{-2pt}{\small $45,9$}}
\psfrag{46-1}{\hspace{-4pt}\raisebox{-2pt}{\small $46,1$}} 
\psfrag{46-2}{\hspace{-4pt}\raisebox{-2pt}{\small $46,2$}} 
\psfrag{46-3}{\hspace{-4pt}\raisebox{-2pt}{\small $46,3$}} 
\psfrag{46-4}{\hspace{-4pt}\raisebox{-2pt}{\small $46,4$}} 
\psfrag{46-5}{\hspace{-4pt}\raisebox{-2pt}{\small $46,5$}} 
\psfrag{46-6}{\hspace{-4pt}\raisebox{-2pt}{\small $46,6$}} 
\psfrag{46-7}{\hspace{-4pt}\raisebox{-2pt}{\small $46,7$}}  
\psfrag{46-8}{\hspace{-4pt}\raisebox{-2pt}{\small $46,8$}} 
\psfrag{46-9}{\hspace{-4pt}\raisebox{-2pt}{\small $46,9$}}
\psfrag{47-1}{\hspace{-4pt}\raisebox{-2pt}{\small $47,1$}} 
\psfrag{47-2}{\hspace{-4pt}\raisebox{-2pt}{\small $47,2$}} 
\psfrag{47-3}{\hspace{-4pt}\raisebox{-2pt}{\small $47,3$}} 
\psfrag{47-4}{\hspace{-4pt}\raisebox{-2pt}{\small $47,4$}} 
\psfrag{47-5}{\hspace{-4pt}\raisebox{-2pt}{\small $47,5$}} 
\psfrag{47-6}{\hspace{-4pt}\raisebox{-2pt}{\small $47,6$}} 
\psfrag{47-7}{\hspace{-4pt}\raisebox{-2pt}{\small $47,7$}}  
\psfrag{47-8}{\hspace{-4pt}\raisebox{-2pt}{\small $47,8$}} 
\psfrag{47-9}{\hspace{-4pt}\raisebox{-2pt}{\small $47,9$}}
\psfrag{48-1}{\hspace{-4pt}\raisebox{-2pt}{\small $48,1$}} 
\psfrag{48-2}{\hspace{-4pt}\raisebox{-2pt}{\small $48,2$}} 
\psfrag{48-3}{\hspace{-4pt}\raisebox{-2pt}{\small $48,3$}} 
\psfrag{48-4}{\hspace{-4pt}\raisebox{-2pt}{\small $48,4$}} 
\psfrag{48-5}{\hspace{-4pt}\raisebox{-2pt}{\small $48,5$}} 
\psfrag{48-6}{\hspace{-4pt}\raisebox{-2pt}{\small $48,6$}} 
\psfrag{48-7}{\hspace{-4pt}\raisebox{-2pt}{\small $48,7$}}  
\psfrag{48-8}{\hspace{-4pt}\raisebox{-2pt}{\small $48,8$}} 
\psfrag{48-9}{\hspace{-4pt}\raisebox{-2pt}{\small $48,9$}}
\psfrag{49-1}{\hspace{-4pt}\raisebox{-2pt}{\small $49,1$}} 
\psfrag{49-2}{\hspace{-4pt}\raisebox{-2pt}{\small $49,2$}} 
\psfrag{49-3}{\hspace{-4pt}\raisebox{-2pt}{\small $49,3$}} 
\psfrag{49-4}{\hspace{-4pt}\raisebox{-2pt}{\small $49,4$}} 
\psfrag{49-5}{\hspace{-4pt}\raisebox{-2pt}{\small $49,5$}} 
\psfrag{49-6}{\hspace{-4pt}\raisebox{-2pt}{\small $49,6$}} 
\psfrag{49-7}{\hspace{-4pt}\raisebox{-2pt}{\small $49,7$}}  
\psfrag{49-8}{\hspace{-4pt}\raisebox{-2pt}{\small $49,8$}} 
\psfrag{49-9}{\hspace{-4pt}\raisebox{-2pt}{\small $49,9$}}
...
to estimate the general complexity of Algorithm II. For the sake of reader's convenience we refer to the steps \ref{it:C2} --- \ref{it:C16} of the summary of Algorithm II, Section \ref{subs_summaryII}, when appropriate. Denote by $E_k
...
\begin{equation}\label{eq:D'_Z}
 t_{\D^\prime_Z}= V^2(|V\D_{1,5}|+|V\D_{2,5}|),
\end{equation}
where, as before $|V\D_{1,5}|$ and $|V\D_{2,5}|$ can be estimated 
using \ref{vtheta5}, \ref{etheta5}, \ref{vtheta4} and \ref{etheta4}.\\[1em]
...
\begin{equation}\label{eq:D'_Z}
 t_{\D''}=|V\D'_5|\cdot |V\D'_Z|\le V(|V\D_{1,5}|+|V\D_{1,5}|).
\end{equation}

\noindent{\bf Total time for Algorithm II.}
The time $t_{\D}$ required to carry out   Algorithm II, on input $\D$, is thus 
bounded by  
\begin{align*}\label{eq:alg2} 
t_{\D}&=t_{\D^\prime_5}+t_{\D'_Z}+t_{\D^{\prime\prime}}\\
&=t_{\D_1}+ t_{\D_2}+V(|V\D_{1,5}|+|V\D_{2,5}|)^2+V^2(|V\D_{1,5}|+|V\D_{2,5}|)
+V(|V\D_{1,5}|+|V\D_{2,5}|)
\end{align*} 

 The numbers of vertices and edges of $\D_5^\prime$ can be estimated
using \ref{vtheta5}, \ref{etheta5}, \ref{vtheta4} and \ref{etheta4} above.
We have 
\begin{align*}
|V\D_5'|&\le |V\D_{1,5}|+|V\D_{2,5}|\\  
&\le \sum_{k=1}^2[|V\D_{k,4}|+2(\overline{Q}''_k+R_k)\cdot(q_k^2-q_k)],\, (\textrm{from \ref{vtheta5}})\\
&\le  \sum_{k=1}^2[V + (\overline{Q}_k V rq +1)\cdot(R_k e +\overline{R}_k B_{Q_k}
 \cdot(V^2 + e^2 + V e)) +\\
& + V^2 q_k (\overline{Q}_k r_k +\overline{Q}_k +R_k)], \,(\textrm{from \ref{vtheta5}}).
\end{align*}
