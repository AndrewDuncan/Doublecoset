\message{ !name(membership.tex)}\documentclass[a4paper,10pt]{article}
...
\message{ !name(membership.tex) !offset(-3) }
...
Here the assumptions are as for Algorithm II.
...
\message{ !name(membership.tex) !offset(-6227) }
