...
\psfrag{49}{\hspace{-2pt}\raisebox{-2pt}{\scriptsize $49$}}
%\includegraphics[scale=0.5]{python/ex_K_f5.eps}
%\includegraphics[scale=0.8, bb=36 36 892 854]{python/ex_K_f5_neato.eps}
\includegraphics[scale=0.8]{python/ex_K_f5_neato.eps}
\caption{$\Theta_5$}
\label{fig:K_f5}
\end{center}
\end{figure}
...
%\hspace*{-3em}
\includegraphics[width=\textwidth, height=.9\textheight, keepaspectratio=false]{python/ex_K_reassembly_neato.eps}
%\includegraphics[scale=0.6]{python/ex_K_reassembly_neato.eps}
