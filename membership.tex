...
Stallings automaton $\G$ for $H$ in time at most $t_1(N)$, as above.

In what follows we will  frequently  use the time complexity of the 
 construction of a spanning subtree of a graph, and of taking graph
products. 
...
{\ajd Which is which? Can we use Tarjan's or Chazelle's algorithm instead?
Probably it's not worth bothering as this part of the process doesn't
...
its subset $L^{\prime}_{Q_k}$, defined below), the set $P_0$  of 
