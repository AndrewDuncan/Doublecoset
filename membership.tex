...
form $f_1^\prime \cdots f_{k^\prime}^\prime$ for $w^\prime$. Hence $k=k^\prime$. 
...
This step involves th addition of paths labeled by $X_k$-words corresponding to
...
its spanning subforest and project to paths in $\G_{A_k}$.
