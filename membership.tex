...
\end{center}
\end{figure}
\begin{lemma}\label{lem:nfcomp1}
Let $\a$ and $\b$ be boundary vertices of  an $X_k$ component $\T$ of
an inverse automaton $\D$, with alphabet $\S$. Then  
%\be
...
same component. From Lemma \ref{lem:nfcomp1} it
