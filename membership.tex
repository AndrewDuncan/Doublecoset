...
set $\vim(w,k)=\vim(u,k)\cup \vim(v,k)$. This process will be
called \emph{updating}
$\vim$, from now on. The sets $\vim(u,k)$ and $\vim(v,k)$ may be deleted. 
...
shown in Figure \ref{fig:KY}. Each of these components is input to
